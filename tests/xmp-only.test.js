...
describe('XMP-only Processing', () => {
  ...
  test('should process XMP-only-example1.jpg with --set option and generate indicator set file', async () => {
    const xmpOnlyFile = path.join(testHelpers.testFilesDir, 'XMP-only-example1.jpg');
    ...
    const result = testHelpers.runCLI(xmpOnlyFile, testHelpers.testDir, ['--set']);
